        ...
        <section className="overflow-hidden py-16 md:py-32">
            <div className="mx-auto max-w-5xl space-y-8 px-6 md:space-y-12">
                <div className="relative z-10 max-w-2xl">
                    <h2 className="text-4xl font-semibold lg:text-5xl">AI Powered vision Board</h2>
                    <p className="mt-6 text-lg">Plan, track, and adapt your tasks effortlessly with an intelligent calendar — sync with workflows, automate with AI, and never miss a deadline again.</p>
                </div>
