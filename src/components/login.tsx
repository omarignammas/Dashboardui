...
export default function LoginPage() {
    return (
        <section className="flex min-h-screen bg-zinc-50 w-full px-4 py-16 md:py-32 dark:bg-transparent">
            <form
                action=""
                ...
                <div className="bg-card -m-px rounded-[calc(var(--radius)+.125rem)] border p-8 pb-6">
                    <div className="text-center">
                        ...
                        <h1 className="mb-1 mt-4 text-xl font-semibold">Sign In to Faundy</h1>
                ...
                <div className="p-3">
                    <p className="text-accent-foreground text-center text-sm">
                        ...
                        <Button
                            ...
                            variant="link"
                            className="px-2">
                            <Link href="/index/signup">Create account</Link>
                        </Button>
                    </p>
                </div>
            </form>
