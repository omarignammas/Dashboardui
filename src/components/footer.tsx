    ...
    return (
        <footer className="py-16 md:py-32">
            ...
            <Link
                ...
                {/* Brand name */}
                <span className="text-2xl -ml-4 font-bold">Faundy</span>
            </Link>
                ...
                <span className="text-muted-foreground block text-center text-sm"> © {new Date().getFullYear()} Faundy, All rights reserved</span>
            </div>
        </footer>
    )
}
